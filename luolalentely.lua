				...
				for i=2,5 do
						if btn((s.id-1)*8+i) then
								...
								if keymap[j] and keymap[j][(s.id-1)+i]==1 then
										...
										else if inventory[j][inventory[j].i] then s.shot1={invi=inventory[j].i,nrj=idtags[inventory[j][inventory[j].i].id].nrj}; if s.shot2 and s.shot2.invi==inventory[j].i then s.shot2=nil end end 
										end
										end
										if i==5 then if inventory[j][inventory[j].i] then s.shot2={invi=inventory[j].i,nrj=idtags[inventory[j][inventory[j].i].id].nrj}; if s.shot1 and s.shot1.invi==inventory[j].i then s.shot1=nil end end 
										end
								end
